...
public class Main {
    public static void main(String[] args) {
        //Ha veces me pasaba que al abrir el proyecto solo habría la carpeta src como proyecto, en ese caso se deberá cerrar el proyecto y abrir la carpeta tresRaya (La carpeta con todo el proyecto).
